        ...
        <style>
            ...
            * {
            ...
            .chat-pattern {
                ...
                bottom: 0;
                background-image: 
                    radial-gradient(circle at 20px 80px, rgba(16, 185, 129, 0.05) 0%, transparent 50%),
                    radial-gradient(circle at 80px 20px, rgba(107, 70, 193, 0.05) 0%, transparent 50%),
        ...
        <section id="demo" class="section-padding">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    </div>                    <div class="col-lg-6" data-aos="fade-left">
                                ...
                                <div class="chat-input">
                                    <div class="input-container">
                                        <div class="input-field">
                                            ...
                                            <input type="text" placeholder="Ketik pertanyaan tentang bahasa Jawa..." id="demoInput">
                                        </div>
                                        <button class="send-button" onclick="sendDemoMessage()">
